			...
			if( etcurso.getText().toString().length() >= 3 )
			{
				try
				{
					...
					//tarefas
						...
						JSONObject t11 = new JSONObject(); t11.put("check", "0"); t11.put("nome", "Orientações gerais sobre a Prática."); t11.put("descricao", ""); t1.put(t11);
						JSONObject t12 = new JSONObject(); t12.put("check", "0"); t12.put("nome", "Definição das equipes."); t12.put("descricao", ""); t1.put(t12);					
						JSONObject t13 = new JSONObject(); t13.put("check", "0"); t13.put("nome", "Definição do tema tendo como base os Termos de Referência."); t13.put("descricao", ""); t1.put(t13);
						JSONObject t14 = new JSONObject(); t14.put("check", "0"); t14.put("nome", "Definição da topologia da Prática."); t14.put("descricao", ""); t1.put(t14);					
						et1.put("tarefas", t1);					
					...
					//tarefas
						...
						JSONObject t21 = new JSONObject(); t21.put("check", "0"); t21.put("nome", "Estudos relacionados ao conteúdo do tema ( leitura de livros, textos, revistas, filmes, entre outros )."); t21.put("descricao", ""); t2.put(t21);
						et2.put("tarefas", t2);
					...
					//tarefas
						...
						JSONObject t31 = new JSONObject(); t31.put("check", "0"); t31.put("nome", "Título da atividade."); t31.put("descricao", ""); t3.put(t31);
						JSONObject t32 = new JSONObject(); t32.put("check", "0"); t32.put("nome", "Organização do conteúdo a ser tratado na aula: esquema ou resumo, entre outros."); t32.put("descricao", ""); t3.put(t32);					
						JSONObject t33 = new JSONObject(); t33.put("check", "0"); t33.put("nome", "Definição dos procedimentos didáticos a utilizar na aula."); t33.put("descricao", ""); t3.put(t33);
						et3.put("tarefas", t3);
					...
					//tarefas
						...
						JSONObject t41 = new JSONObject(); t41.put("check", "0"); t41.put("nome", "Apresentação da aula planejada."); t41.put("descricao", ""); t4.put(t41);
						JSONObject t42 = new JSONObject(); t42.put("check", "0"); t42.put("nome", "Registro de ocorrências."); t42.put("descricao", ""); t4.put(t42);					
						et4.put("tarefas", t4);
					...
					//tarefas
						...
						JSONObject t51 = new JSONObject(); t51.put("check", "0"); t51.put("nome", "Ordenar e analisar as anotações feitas."); t51.put("descricao", ""); t5.put(t51);
						JSONObject t52 = new JSONObject(); t52.put("check", "0"); t52.put("nome", "Escrever o paper."); t52.put("descricao", ""); t5.put(t52);					
						et5.put("tarefas", t5);
					...
					//tarefas
						...
						JSONObject t61 = new JSONObject(); t61.put("check", "0"); t61.put("nome", "Organização do conteúdo a ser apresentado: esquema ou resumo, entre outros."); t61.put("descricao", ""); t6.put(t61);
						JSONObject t62 = new JSONObject(); t62.put("check", "0"); t62.put("nome", "Preparação do material a ser usado na aula: slide, ficha-resumo, entre outros."); t62.put("descricao", ""); t6.put(t62);					
						JSONObject t63 = new JSONObject(); t63.put("check", "0"); t63.put("nome", "Preparação dos instrumentos necessários: projetor multimídia, entre outros."); t63.put("descricao", ""); t6.put(t63);
						JSONObject t64 = new JSONObject(); t64.put("check", "0"); t64.put("nome", "Fazer a apresentação."); t64.put("descricao", ""); t6.put(t64);					
						et6.put("tarefas", t6);
